...
class ProfileViewModelTest {
    ...
    private lateinit var getUserRegisterDateUseCase: GetUserRegisterDateUseCase
    ...
    fun setUp() {
        ...
        getUserRegisterDateUseCase = mockk()
    ...
    private fun createViewModel() = ProfileViewModel(
        ...
        getUserRegisterDateUseCase = getUserRegisterDateUseCase,
    ...
    @Test
    fun `activityState считается по дате регистрации больше 30 дней`() = runTest {
        ...
        every { getUserRegisterDateUseCase() } returns registerDate
