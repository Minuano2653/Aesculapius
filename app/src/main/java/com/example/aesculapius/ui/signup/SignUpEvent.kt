...
sealed interface SignUpEvent {
    ...
    data class OnClickRegister(val login: String, val password: String) : SignUpEvent
    data class OnCheckEmailIsValid(val email: String) : SignUpEvent
